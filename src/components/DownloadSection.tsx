      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600">
            Your personal operating system, always with you. Available now for iPhone and Android.
          </p>
        </div>

        {/* Download Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-5xl mx-auto">
          {/* Left Column: Official Store Badges */}
          <div className="lg:col-span-7 p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm space-y-6">
            <div className="flex items-center gap-3.5 pb-6 border-b border-slate-100">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">
                  Free full access · No ads · No account required
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 inline-flex items-center gap-3.5 px-5 py-3.5 rounded-2xl bg-black hover:bg-neutral-900 text-white border border-neutral-800 shadow-md hover:shadow-lg transition-all group cursor-pointer"
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] uppercase font-mono tracking-wider text-neutral-400 font-medium leading-none">
                    Download on the
                  </p>
                  <p className="text-base font-bold font-sans tracking-tight text-white mt-0.5 leading-tight">
                    App Store
                  </p>
                </div>
              </a>
          ...
          <div className="lg:col-span-5 p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex flex-col items-center text-center space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Scan with your phone camera to download directly to your device.
              </p>
            </div>
